...
%===================================
    ...
    data1 = csvread('C:\Users\qeng1\Documents\Code\Mathematical Modeling\2021国赛\data\A\appendix1.csv');
    data2 = csvread('C:\Users\qeng1\Documents\Code\Mathematical Modeling\2021国赛\data\A\appendix2.csv');
    %fprintf('data 2 processed, size = %d x %d\n',size(data2,1),size(data2,2));
    %fprintf('data 1 processed, size = %d x %d\n',size(data1,1),size(data1,2));
    
    %[~,name,~] = xlsread('C:\Users\qeng1\Documents\Code\Mathematical Modeling\2021国赛\data\A\1.csv');
    %surface = xlsread('C:\Users\qeng1\Documents\Code\Mathematical Modeling\2021国赛\data\A\3v2.csv');
